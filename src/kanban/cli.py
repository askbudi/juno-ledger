...
class TaskCLI:
    ...
    def _reject_shell_sensitive_inline_create_body(self, body: Optional[str]) -> Optional[int]:
        ...
        print(
            ...
            "your shell cannot expand backticks, $(), heredocs, or multiline content before juno-kanban sees it.",
            file=sys.stderr,
        )
    ...
    def _emit_phase_timing(phase: str, started: float, **details):
        if os.environ.get('JUNO_KANBAN_DIAGNOSTICS', '').lower() not in ('1', 'true', 'yes'):
            return
...
'''
    ...
    def show_help(self, args: argparse.Namespace) -> int:
        ...
        print("  JUNO_KANBAN_REGISTRY_ENABLED=true|false")
        print("  JUNO_KANBAN_REGISTRY_ALLOWED_PROJECTS=alias,alias")
        print("  JUNO_KANBAN_REGISTRY_PATH=PATH   Override the user registry path")
        print()
