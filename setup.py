...
def read_version():
    """Read version from kanban/__init__.py (single source of truth)."""
    init_path = os.path.join(os.path.dirname(__file__), 'src', 'kanban', '__init__.py')
...
setup(
    ...
    project_urls={
        "Bug Reports": "https://github.com/askbudi/juno-ledger/issues",
